              ...
              {filteredPartners.length === 0 ? (
                ...
                filteredPartners.map((partner) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span
                        className={`px-3 py-1 font-semibold text-xs rounded-full inline-flex items-center gap-1.5 ${partner.status === "Đang hoạt động"
                            ? "bg-emerald-50 text-emerald-600 border border-emerald-200/70"
                            : "bg-rose-50 text-rose-600 border border-rose-200/70"
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${partner.status === "Đang hoạt động"
                              ? "bg-emerald-500"
                              : "bg-rose-500"
                            }`}
                        />
