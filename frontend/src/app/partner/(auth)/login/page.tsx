        ...
        <div className="relative z-10">
          ...
          <div className="mt-20 text-white max-w-lg">
            <h2 className="text-4xl font-bold leading-tight mb-6">
              Mở rộng kinh doanh cùng Lumina.
            </h2>
            <p className="text-lg text-blue-100/80 mb-10">
              Đăng nhập để quản lý voucher, chi nhánh và theo dõi doanh thu của bạn.
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                ...
                <span className="text-blue-50 text-lg">Quản lý voucher dễ dàng</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                  <Check className="w-5 h-5 text-white" />
                </div>
                <span className="text-blue-50 text-lg">Theo dõi doanh thu realtime</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                  <Check className="w-5 h-5 text-white" />
                </div>
                <span className="text-blue-50 text-lg">Tiếp cận hàng ngàn khách hàng</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md animate-fadeIn">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-500">Chào mừng bạn quay trở lại hệ thống quản lý đối tác.</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Nhập email đối tác của bạn"
                  required
                  autoFocus
