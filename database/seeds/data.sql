...
-- 1. Insert core system root users (Admin + Sample Customer)
...
-- 2. Note: Toàn bộ danh mục (Categories) sẽ được bóc tách và nạp động 100% từ dữ liệu cào thực tế trong scraped_vouchers.sql hoặc crawler engine.
